...
namespace EZCameraShake
{
    ...
    public class CameraShaker : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            deflection = transform.localPosition.sqrMagnitude * transform.localEulerAngles.sqrMagnitude;
            Camera.main.transform.GetComponent<AnalogGlitch>().scanLineJitter = deflection / 12000f;
            Camera.main.transform.GetComponent<AnalogGlitch>().colorDrift = deflection / (12000f * 0.5f);
            Camera.main.transform.GetComponent<AnalogGlitch>().verticalJump = deflection / (12000f * 7f);
            var noise = GameManager.Instance.airStripes.noise;
            noise.strength = deflection / 12000f;
        }
